...
#ifndef _BOOST_HISTOGRAM_STORAGE_ADAPTIVE2_HPP_
#define _BOOST_HISTOGRAM_STORAGE_ADAPTIVE2_HPP_
...
public:
  ...
  array(array &&rhs) : size(rhs.size), ptr(rhs.ptr) { rhs.ptr = nullptr; }
...
public:
  ...
  explicit adaptive_storage2(std::size_t s) : buffer_(array<void>(s)) {}

  adaptive_storage2() = default;
  adaptive_storage2(const adaptive_storage2 &) = default;
  adaptive_storage2 &operator=(const adaptive_storage2 &) = default;
  adaptive_storage2(adaptive_storage2 &&) = default;
  adaptive_storage2 &operator=(adaptive_storage2 &&) = default;

  template <typename OtherStorage, typename = detail::is_storage<OtherStorage>>
  explicit adaptive_storage2(const OtherStorage &rhs)
  ...
  template <typename OtherStorage, typename = detail::is_storage<OtherStorage>>
  adaptive_storage2 &operator=(const OtherStorage &rhs) {
  ...
  bool operator==(const adaptive_storage2 &o) const {
...
bool operator==(const OtherStorage &a, const adaptive_storage2<Allocator> &b) {
  return (&b)->operator==(a);
}
